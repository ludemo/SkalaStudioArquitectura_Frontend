...
export default function Formulario() {
    const [datosPDF, setDatosPdf] = useState({nombre: '', fechaInicio: '',horario: '8:30 a 10:30pm L a V', modalidad: 'virtual', nivel: 'basico'}); 
    ...
    <form onKeyDown={handleKeyDown}  id = "form" action="">
        ...
        <div className={`botones ${ currentSection === 0 ? 'justify-right' : 'justify-space-between' }`} id="botones">
            ...
            { currentSection ===3 && <button onKeyDown = { handleKeyDown} type="submit" onClick = {enviarDatos} id="enviar" className="inscripcion__boton boton--enviar boton--form" value="Enviar">Enviar</button>}
        </div>
    </form>
    ...
    { envioDatos && 
     <div id = "carga" className = "fixed carga">
        ...
        <div className = "carga__info">
            <p>Gracias por registrarte, se te estara enviando una notificación a un correo con la confirmación de tu matricula cualquier duda no dudes en escribirnos😉</p>
