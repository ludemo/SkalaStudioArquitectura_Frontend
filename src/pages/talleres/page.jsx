                ...
                <div className="portada--limitador limitador">
                    ...
                    <div className="titulo titulo--talleres">
                        <div className="titulo__texto titulo__texto--talleres">
                            <h1 className="titulo__subtitulo1 titulo__subtitulo1--talleres">Nuestros</h1>
                        ...
                        <div className="navegacion--talleres">
                            ...
                            <div className="navegacion__elemento">
                                ...
                                <h4 className="navegacion__elemento__text">Geometría <br/>Descriptiva</h4>
                            </div>
                            <div className="navegacion__elemento">
                                <a href="#dibujo">
                                    <div className="simbolo simbolo--dibujo"></div>
                                </a>
                                <h4 className="navegacion__elemento__text">Dibujo <br/>Técnico</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="contenido">
                <div className="limitador">
                    <div className="talleres__información">
                        <p className="talleres__texto">Los Talleres Skala se aperturan cada verano, por lo que en estos meses no se ofertan. 
                            Aún así existe la siguiente modalidad para el resto del año:</p>
                        <h5 className="subtitulo-curso">Si aún no llegó el verano forma tu grupo:</h5>
                        <div className="temas-contenedor">
                            <div className="temas">
                                ...
                                <div className="opcion">
                                    ...
                                    <p className="opcion__texto">Tu grupo debe tener 5 personas</p>
                                </div>
                                <div className="opcion">
                    ...
                    <div id="maqueteria" className="contenido__curso maqueteria">
                        <div className="titulo-curso">
                            <div className="titulo-curso__texto">
                                <h2 className="titulo-curso__subtitulo2 title2__curso">Maque</h2>
                                <h2 className="titulo-curso__subtitulo1 title1__curso">Tería</h2>
                            </div>
                            <div className="titulo-curso__texto2">
                                ...
                                <p>Para estudiantes y <br/>profesionales</p>
                            </div>
                            
                        </div>
                        <p className="info">
                            Aprende los instrumentos, habilidades y técnicas para
                            la elaboración de maquetas arquitectónicas
                        </p>
                    ...
                    <div id="geometria" className="contenido__curso geometria">
                        <div className="titulo-curso ">
                            <div className="titulo-curso__texto">
                                <h2 className="titulo-curso__subtitulo2 title2__curso">Geome</h2>
                        ...
                        <p className="info">Te proporcionamos las herramientas necesarias para que puedas dominar la representación geométrica de objetos en el espacio. 
                        </p>
                        ...
                        <div className="temas">
                            ...
                            <div className="opcion">
                                <div className="opcion__numero">03</div>
                                <p className="opcion__texto">Intersección entre Formas compuestas</p>
                            </div>
                        </div>
                    </div>
                    <hr/>
                    <div id="dibujo" className="contenido__curso dibujo">
                        <div className="titulo-curso ">
                            <div className="titulo-curso__texto ">
                                <h2 className="titulo-curso__subtitulo2 title2__curso">dibujo</h2>
                                <h2 className="titulo-curso__subtitulo1 title1__curso">ténico</h2>
                            </div>
                            <div className="titulo-curso__texto2">
                        ...
                        <div className="info">Aprenderás técnicas esenciales de dibujo, para representar proyectos en forma detallada con un enfoque en la precisión y la escala. 
                        </div>
                        <h4 className="subtitulo-curso">Algunos temas generales</h4>
                        <div className="temas">
                            <div className="opcion">
                            ...
                            <div className="opcion">
                                <div className="opcion__numero">03</div>
                                <p className="opcion__texto">Planos de planta, cortes y elevaciones</p>
                            </div>
                        </div>
                    </div>
                </div>
