          ...
          <div className='titulo titulo--talleres'>
            ...
            <div className='navegacion--talleres'>
              <div className='navegacion__elemento'>
                <a href='#maqueteria'>
                  <div className='simbolo simbolo--maqueteria' />
                </a>
                <h4 className='navegacion__elemento__text'>Maquetería</h4>
              </div>
              <div className='navegacion__elemento'>
                <a href='#geometria'>
                  <div className='simbolo simbolo--geometria' />
                </a>
              ...
              <div className='navegacion__elemento'>
                <a href='#dibujo'>
                  <div className='simbolo simbolo--dibujo' />
                </a>
                <h4 className='navegacion__elemento__text'>
                  Dibujo <br />
                  Técnico
        ...
        <div className='limitador'>
          ...
          <div id='maqueteria' className='contenido__curso maqueteria'>
            <div className='titulo-curso'>
              ...
              <div className='titulo-curso__texto2'>
                <div className='titulo-curso__texto2__imagen titulo-curso__texto2__imagen--first simbolo simbolo--maqueteria' />
                <p>
          ...
          <div id='geometria' className='contenido__curso geometria'>
            <div className='titulo-curso '>
              ...
              <div className='titulo-curso__texto2'>
                <div className='titulo-curso__texto2__imagen simbolo simbolo--geometria' />
                <p>
                  Para estudiantes y <br />
                  profesionales
                </p>
          ...
          <div id='dibujo' className='contenido__curso dibujo'>
            <div className='titulo-curso '>
              ...
              <div className='titulo-curso__texto2'>
                <div className='titulo-curso__texto2__imagen simbolo simbolo--dibujo' />
                <p>
                  Para estudiantes y <br />
                  profesionales
                </p>
